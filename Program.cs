...
namespace ATM__cajero_automatico_
{
    internal class Program
    {
        ...
        static void Billetes_0_a_15(double retiro)
        {
            ...
            Mostrar_billetes(Billetes_de_uno, Billetes_de_cinco, Billetes_de_diez, Billetes_de_veinte);
        }
        //Función para calcular cuantos billetes se tienen que dar para la cantidad de retiro entre $ 15 a $ 50
        static void Billetes_15_a_50(double retiro)
        {
            ...
            int Billetes_de_diez = 0;
            int Billetes_de_veinte = 0;
            const double porcentaje_10 = 0.75, Porcentaje_B_5 = 0.25;
            ...
            Billetes_de_cinco = Convert.ToInt16(((double)Math.Round(retiro  * Porcentaje_B_5) / 5));// Multiplicamos la variable retiro* Porcentaje_B_5 y lo dividimos entre 10 y nos da la cantidad de billetes de a cinco
